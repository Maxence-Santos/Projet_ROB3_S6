...
void alignement() {
  ...
  float d1= // premiere mesure ( il faut mettre la fonction pour mesure la distance entre le capteur et le mur )
  // il faut mettre la fonction avancer et lui dire d'avance de distance_avance
  delay(200);
  updateOdometry();
  float d2= // deuxieme mesure ( il faut mettre la fonction pour mesure la distance entre le capteur et le mur )
  float diff=d2-d1;
